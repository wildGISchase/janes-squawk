...
let divChapter0 = '<h3>Hello, thank you for your interest in our Jane\'s Walk!</h3><p>We\'re building out the site at the moment.</p><p>Please feel free to bookmark the page for now. <b>We look forward to sharing our walk with you at the start of Jane\'s Walk weekend on May 5th!</b></p>';
...
let divChapter15 = '<img src="assets/images/stop-4.jpeg"><p>Again, the trail gave way to an expansive view, this time of West Pond itself. Zipping and acrobatically changing direction as they flew above the pond were dozens of Tree Swallows, their blue-green feathers shimmering in the sunlight as they chased flies.</p><p>This was also our first glimpse of swimming birds; namely, Mallards and a flock of Bufflehead Ducks, with their unmistakable white and black bodies and tufted white heads.</p>';
...
let divChapter17 = '<img src="assets/images/stop-6.jpeg"><p>At this point, anything else seemed like icing on the cake. So as we rounded the easternmost curve of the trail, we were excited to see dozens of Brants, their white bodies and black heads bobbing among the whitecaps of the bay with the Manhattan skyline as a backdrop.</p>';
...
let divChapter19 = '<img src="assets/images/stop-8.jpeg"><p>As we approached the halfway point of the walk, we encountered two familiar faces: Canada Geese. These two seemed unfazed by our presence, perhaps because they appeared to be guarding some goslings to-be.</p>';

let divChapter20 = '<p>Earlier, one of the fellow birders we encountered on the trail had encouraged us to be on the lookout for a bird that neither of us had heard of before. Fittingly, as we progressed along the trail\'s northern straightaway, we saw the bird--an Eastern Towhee--perched in a small tree above the trail. And indeed, the small bird, with its bright orange belly and black-capped head, was a striking and gratifying one to view.</p>';

let divChapter21 = '<p>After rounding the final corner of the loop, we were presented with two options: continue down the gravel trail or divert down an offbeaten grassy path through the woods. Of course we chose the latter!</p><p>As we immersed ourselve in forest at the edge of the marsh, we were immediately rewarded with the cheerful spring chorus of at least half a dozen birds, including a Yellow Warbler, Carolina Wren, White Throated Sparrow, Common Yellothroat, and Northern Parula.</p>';

let divChapter22 = '<p>Coming out of the forest, we returned to the trail and the final straightaway back to the visitor center. Walking along the familiar gravel path, we heard the overhead cackle of Laughing Gulls, soaring one by one with their blue caps and wingtips against the clear blue sky.</p>';

let divChapter23 = '<p>Were they amused by these amateurs, squinting up and trying to make out who they were? Perhaps. But at the end of the day, it was these amateurs--with our reams of sightings notes, photos, and memories--who could smile and most happily laugh.</p>';
